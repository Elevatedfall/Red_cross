...
class LoginPage extends StatelessWidget {
  ...
  String extractBranchName(String email) {
    final startIndex = email.indexOf('@') + 1;
    final endIndex = email.lastIndexOf('.');
    final branchName = email.substring(startIndex, endIndex);
    return branchName;
  }

  bool isMainBranch(String branchName) {
    return branchName.toLowerCase() == 'main';
  }
